...
<head>
	...
	<link rel="mask-icon" href="/assets/icons/safari-pinned-tab.svg" color="#5486a7">
	<link rel="shortcut icon" href="/assets/icons/favicon.ico">
	<meta name="msapplication-TileColor" content="#fff6ef">
	...
	<div class="mc-container">
		<header class="mc-header">
			...
			<div class="mc-heading">
				<h1><img src="assets/graphics/logo-full.svg" width="313" height="88" alt="MECCFOR - Design & Forniture Componenti Meccanici" class="mc-logo-full"></h1>
			</div>
		...
		<div class="mc-content mc-content-homepage">
			<img width="1920" height="1280" alt="MECCFOR - Design & Forniture Componenti Meccanici" srcset="
